...
int color(int r,int g,int b,int a)
{
    ...
    if(r >= 0 && r <= 255 && g >= 0 && g <= 255 && b >= 0 && b <= 255 && a >= 0 && a <= 255) //如果颜色值的范围在0 - 255之间
    {
        red = r * 0x1000000; //red值
        green = g * 0x10000; //green值
        blue = b * 0x100; //blue值
        color_code = red + green + blue + a; //获取颜色码
    }
    else
    {
...
// rgb颜色
//--------------------------------------------------------------------
int color3(int r,int g,int b)
{
    int red = 0x00; //red值
    int green = 0x00; //green值
    int color_code = 0x00; //颜色码
    if(r >= 0 && r <= 255 && g >= 0 && g <= 255 && b >= 0 && b <= 255) //如果颜色值的范围在0 - 255之间
    {
        red = r * 0x10000; //red值
        green = g * 0x100; //green值
        color_code = red + green + b; //获取颜色码
    }
    else
    {
        cprint("ERROR : The color value is error.");
