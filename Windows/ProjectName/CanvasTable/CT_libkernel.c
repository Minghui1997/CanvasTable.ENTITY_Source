...
int color(int r,int g,int b,int a)
{
    ...
    else
    {
        ...
        char arg1[8] = ""; 
        char arg2[8] = "";
        strcat(infor,"ERROR 15 : The color value is error. ColorValue : ");
        sprintf(arg0,"%d",r);
        strcat(infor,arg0);
        cprint(infor);
    }
...
{
    cprint("ERROR -1 : This function is invalid in CanvasTable.ENTITY,please use function istring_pxwidth().");
    return 0;
}
//--------------------------------------------------------------------