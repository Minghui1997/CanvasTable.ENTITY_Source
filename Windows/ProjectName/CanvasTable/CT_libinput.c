...
int keyboard_press(int key)
{
    ...
    else //如果按键键值不在范围内
    {
        ...
        char arg1[8] = "";
        char arg2[8] = "";
        strcat(infor,"ERROR 7 : Key value beyond range. KeyCode : ");
        sprintf(arg0,"%d",key);
        strcat(infor,arg0);
        cprint(infor);
    }
...
int mouse_press(int mkey)
{
    ...
    else //如果鼠标键值不在范围内
    {
        ...
        char arg1[8] = "";
        char arg2[8] = "";
        strcat(infor,"ERROR 8 : Mouse key value beyond range. KeyCode : ");
        sprintf(arg0,"%d",mkey);
        strcat(infor,arg0);
        cprint(infor);
    }
...
int mouse_wheel(int mkey)
{
    ...
    else //如果鼠标滚轮参数不正确
    {
        ...
        char arg1[8] = "";
        char arg2[8] = "";
        strcat(infor,"ERROR 9 : The mouse wheel direction is error. KeyCode : ");
        sprintf(arg0,"%d",mkey);
        strcat(infor,arg0);
        cprint(infor);
    }
...
void touchkey_create(int id,int x,int y,int w,int h,int key)
{
    if(CT_ContainerTouchKey[id][0] == NULL) //如果触摸键容器指定索引为空
    {
        ...
        else
        {
            ...
            char arg1[8] = "";
            char arg2[8] = "";
            strcat(infor,"ERROR 17 : Unable to create TouchKey. TouchKeyID : ");
            sprintf(arg0,"%d",id);
            strcat(infor,arg0);
            cprint(infor);
        }
    ...
    else //如果触摸键容器指定索引不为空
    {
        ...
        char arg1[8] = "";
        char arg2[8] = "";
        strcat(infor,"ERROR 16 : TouchKey have been created. TouchKeyID : ");
        sprintf(arg0,"%d",id);
        strcat(infor,arg0);
        cprint(infor);
    }
...
void touchkey_delete(int id)
{
    ...
    else //如果触摸键容器指定索引为空
    {
        ...
        char arg1[8] = "";
        char arg2[8] = "";
        strcat(infor,"ERROR 18 : The TouchKey is not created. TouchKeyID : ");
        sprintf(arg0,"%d",id);
        strcat(infor,arg0);
        cprint(infor);
    }
