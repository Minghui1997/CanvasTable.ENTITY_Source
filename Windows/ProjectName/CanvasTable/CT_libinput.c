...
extern int CT_ContainerTouchKey[32][7];
...
int keyboard_press(int key)
{
    ...
    {
        cprint("ERROR : The key value is the beyond range.");
    }
    return 0;
}
//--------------------------------------------------------------------
...
int mouse_press(int mkey)
{
    ...
    {
        cprint("ERROR : The mouse key value is the beyond range.");
    }
    return 0;
}
//--------------------------------------------------------------------
...
{
    if(CT_ContainerTouchKey[id][0] == 0) //如果触摸键容器指定索引为空
    {
    ...
    {
        cprint("ERROR : TouchKey have been create.");
    }
...
void touchkey_delete(int id)
{
    ...
    {
        cprint("ERROR : TouchKey no create.");
    }
}
//--------------------------------------------------------------------
//--------------------------------------------------------------------
