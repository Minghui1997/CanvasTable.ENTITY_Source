    ...
    if(CT_RunnerStatus == 1) //如果运行器状态为1
    {
        if(win->type == 0) //如果对象类型是窗口
        {
            ...
            for(i=0;i<CT_ContainerWindowIndex;i++) //遍历窗口容器
            {
                if(CT_ContainerWindow[i][0] != NULL) //如果当前窗口不为空
                {
                    ...
                    if(win_id == id) //如果当前窗口ID等于窗口ID
                    {
                        ...
                        char arg1[8] = "";
                        char arg2[8] = "";
                        strcat(infor,"ERROR 100 : Window have been created. WindowID : ");
                        sprintf(arg0,"%d",id);
                        strcat(infor,arg0);
                        cprint(infor);
                        return; //中断
            ...
            else
            {
                ...
                char arg1[8] = "";
                char arg2[8] = "";
                strcat(infor,"ERROR 101 : Unable to create window. WindowID : ");
                sprintf(arg0,"%d",id);
                strcat(infor,arg0);
                cprint(infor);
            }
        ...
        else
        {
            ...
            char arg1[8] = "";
            char arg2[8] = "";
            strcat(infor,"ERROR 113 : Not is window object. ObjectID : ");
            sprintf(arg0,"%d",win->id);
            strcat(infor,arg0);
            cprint(infor);
        }
    }
    ...
    if(CT_RunnerStatus == 1) //如果运行器状态为1
    {
        if(win->type == 0) //如果对象类型是窗口
        {
            ...
            for(i=0;i<CT_ContainerUIIndex;i++) //遍历UI容器
            {
                if(CT_ContainerUI[i][0] != NULL) //如果当前UI对象不为空
                {
                    ...
                    if(ui_id == id) //如果当前UI对象的ID等于UI对象ID
                    {
                        ...
                        char arg1[8] = "";
                        char arg2[8] = "";
                        strcat(infor,"ERROR 102 : The UI object has been created. UIobjectID : ");
                        sprintf(arg0,"%d",id);
                        strcat(infor,arg0);
                        cprint(infor);
                        return; //中断
            ...
            if(type == 1) //如果UI是按钮
            {
                ...
                {
                    if(ctui->imgfont->FontImg != -1) //如果资源不为空
                    {
                        if(ctui->imgfont->CharNumber > 0) //如果字体字符数量大于0
                        {
                            if(ctui->imgfont->CharList != NULL && ctui->imgfont->GlyphList != NULL) //如果字体字符列表不为空
                            {
                    ...
                    else
                    {
                        ...
                        sprintf(arg0,"%d",ctui->imgfont->FontImg);
                        strcat(infor,arg0);
                        cprint(infor);
                    }
                }
                ...
                else
                {
                    ...
                    char arg1[8] = "";
                    char arg2[8] = "";
                    strcat(infor,"ERROR 103 : Unable to create button. UIobjectID : ");
                    sprintf(arg0,"%d",id);
                    strcat(infor,arg0);
                    cprint(infor);
                }
            ...
            if(type == 3) //如果UI是复选框
            {
                ...
                else
                {
                    ...
                    char arg1[8] = "";
                    char arg2[8] = "";
                    strcat(infor,"ERROR 121 : Checkbox state error. UIobjectID : ");
                    sprintf(arg0,"%d",id);
                    strcat(infor,arg0);
                    cprint(infor);
                }
            ...
            if(type == 4) //如果UI是单选框
            {
                ...
                else
                {
                    ...
                    char arg1[8] = "";
                    char arg2[8] = "";
                    strcat(infor,"ERROR 106 : Invalid radio group. UIobjectID : ");
                    sprintf(arg0,"%d",id);
                    strcat(infor,arg0);
                    cprint(infor);
                }
            ...
            if(type == 5) //如果UI是进度条
            {
                ...
                if(w > 0 && h > 0) //如果进度条大小正确
                {
                    if(val >= 0 && maxval > 0) //如果进度条值正确
                    {
                        ...
                        else
                        {
                            ...
                            char arg1[8] = "";
                            char arg2[8] = "";
                            strcat(infor,"ERROR 109 : The progressbar value greater than the maximum. UIobjectID : ");
                            sprintf(arg0,"%d",id);
                            strcat(infor,arg0);
                            cprint(infor);
                        }
                    ...
                    else
                    {
                        ...
                        char arg1[8] = "";
                        char arg2[8] = "";
                        strcat(infor,"ERROR 108 : Progressbar value error. UIobjectID : ");
                        sprintf(arg0,"%d",id);
                        strcat(infor,arg0);
                        cprint(infor);
                    }
                ...
                else
                {
                    ...
                    char arg1[8] = "";
                    char arg2[8] = "";
                    strcat(infor,"ERROR 107 : Unable to create progressbar. UIobjectID : ");
                    sprintf(arg0,"%d",id);
                    strcat(infor,arg0);
                    cprint(infor);
                }
            ...
            if(type == 6) //如果UI是文本框
            {
                    ...
                    if(tpass == 0 || tpass == 1) //如果密码文本框参数正确
                    {
                        if(tnumb == 0 || tnumb == 1) //如果数字文本框参数正确
                        {
                            ...
                            else
                            {
                                ...
                                char arg1[8] = "";
                                char arg2[8] = "";
                                strcat(infor,"ERROR 112 : The textbox cannot be input. UIobjectID : ");
                                sprintf(arg0,"%d",id);
                                strcat(infor,arg0);
                                cprint(infor);
                            }
                        ...
                        else
                        {
                            ...
                            char arg1[8] = "";
                            char arg2[8] = "";
                            strcat(infor,"ERROR 111 : Textbox type error. UIobjectID : ");
                            sprintf(arg0,"%d",id);
                            strcat(infor,arg0);
                            cprint(infor);
                        }
                ...
                else
                {
                    ...
                    char arg1[8] = "";
                    char arg2[8] = "";
                    strcat(infor,"ERROR 110 : Unable to create textbox. UIobjectID : ");
                    sprintf(arg0,"%d",id);
                    strcat(infor,arg0);
                    cprint(infor);
                }
...
void CTui_destroy(CTui *ctui)
{
    if(CT_RunnerStatus == 1) //如果运行器状态为1
    {
        ...
        else
        {
            ...
            char arg1[8] = "";
            char arg2[8] = "";
            strcat(infor,"ERROR 120 : Not is UI object. UIobjectID : ");
            sprintf(arg0,"%d",ctui->id);
            strcat(infor,arg0);
            cprint(infor);
        }
    }
            ...
            if(CT_ContainerUI[ui_index][0] != NULL) //如果UI容器中指定窗口对象数据不为空
            {
                ...
                if(Cui_id == ctui->id) //如果UI对象id等于容器中指定UI对象的ID
                {
                    ...
                    if(ui_type == 2 || ui_type == 3 || ui_type == 4) //如果UI对象是文本 复选框 单选框
                    {
                        ...
                        char arg1[8] = "";
                        char arg2[8] = "";
                        strcat(infor,"ERROR 104 : The UI object not have this property. UIobjectID : ");
                        sprintf(arg0,"%d",ctui->id);
                        strcat(infor,arg0);
                        cprint(infor);
                    }
            ...
            if(CT_ContainerUI[ui_index][0] != NULL) //如果UI容器中指定UI对象的数据不为空
            {
                ...
                if(Cui_id == ctui->id) //如果UI对象id等于容器中指定UI对象的ID
                {
                    ...
                    if(ui_type == 2 || ui_type == 3 || ui_type == 4) //如果UI对象是文本 复选框 单选框
                    {
                        ...
                        char arg1[8] = "";
                        char arg2[8] = "";
                        strcat(infor,"ERROR 105 : The UI object not support background image. UIobjectID : ");
                        sprintf(arg0,"%d",ctui->id);
                        strcat(infor,arg0);
                        cprint(infor);
                    }
...
int button_click(CTui *ctui)
{
    if(CT_RunnerStatus == 1) //如果运行器状态为1
    {
        ...
        else
        {
            ...
            char arg1[8] = "";
            char arg2[8] = "";
            strcat(infor,"ERROR 114 : Not is button object. UIobjectID : ");
            sprintf(arg0,"%d",ctui->id);
            strcat(infor,arg0);
            cprint(infor);
        }
...
int checkbox_status(CTui *ctui)
{
    if(CT_RunnerStatus == 1) //如果运行器状态为1
    {
        ...
        else //如果UI对象不是复选框
        {
            ...
            char arg1[8] = "";
            char arg2[8] = "";
            strcat(infor,"ERROR 116 : Not is checkbox object. UIobjectID : ");
            sprintf(arg0,"%d",ctui->id);
            strcat(infor,arg0);
            cprint(infor);
        }
...
int radio_status(CTui *ctui)
{
    if(CT_RunnerStatus == 1) //如果运行器状态为1
    {
        ...
        else //如果UI对象不是复选框
        {
            ...
            char arg1[8] = "";
            char arg2[8] = "";
            strcat(infor,"ERROR 117 : Not is radio object. UIobjectID : ");
            sprintf(arg0,"%d",ctui->id);
            strcat(infor,arg0);
            cprint(infor);
        }
...
void progressbar_set(CTui *ctui,int val)
{
    if(CT_RunnerStatus == 1) //如果运行器状态为1
    {
        ...
        else
        {
            ...
            char arg1[8] = "";
            char arg2[8] = "";
            strcat(infor,"ERROR 118 : Not is progressbar object. UIobjectID : ");
            sprintf(arg0,"%d",ctui->id);
            strcat(infor,arg0);
            cprint(infor);
        }
...
char *textbox_string(CTui *ctui)
{
    if(CT_RunnerStatus == 1) //如果运行器状态为1
    {
        ...
        else //如果UI对象不是复选框
        {
            ...
            char arg1[8] = "";
            char arg2[8] = "";
            strcat(infor,"ERROR 119 : Not is textbox object. UIobjectID : ");
            sprintf(arg0,"%d",ctui->id);
            strcat(infor,arg0);
            cprint(infor);
        }
